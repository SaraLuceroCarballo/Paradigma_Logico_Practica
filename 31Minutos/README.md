...
## 2. Saber si una canción no es reconocida por los críticos, lo cual ocurre si tiene muchas reproducciones y nunca estuvo en el ranking. Una canción tiene muchas reproducciones si tiene más de 7.000.000 reproducciones.
...
## 5. Conocer el sueldo total de una persona, el cual está dado por la suma de los sueldos de cada uno de sus trabajos. El sueldo de cada trabajo se calcula de la siguiente forma:
    ...
    b. El sueldo de un **reportero** es 10100 por cada año de experiencia más  100 por cada nota que haya hecho en su carrera.
